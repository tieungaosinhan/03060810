...
const diary = [
	...
	{ date:`2026-03-24`, state:`s3`, mood:[`m10`], health:`h2`, weather:`w1`, temperature:`t3`, minimal:`d2`, act:[`a2`,`a3`], spend:`sp5`, spendAmount:4500000, song:`Cỏ dại và hoa dành dành`, quotes:`The problem isn’t that we fall in love with the wrong person; it’s that we expect the wrong things from love.  Alain de Botton`, additional:`Hôm nay nóng quá. khó chịu vô cùng luôn á :)` }
];
